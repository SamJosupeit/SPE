...
#region Functions
    ...
    #region Function Use-Choice
	function Use-Choice
	{
        <#
        .SYNOPSIS
        Stellt eine Abfrage von Auswahlmöglichkeiten zur Verfügung und gibt das Ergebnis zurück
        .DESCRIPTION
        Stellt eine Abfrage von Auswahlmöglichkeiten zur Verfügung und gibt das Ergebnis zurück. Die Eingabe wird auf die gesetzten Möglichkeiten beschränkt.
        .EXAMPLE
        $choice = Use-Choice "a,b,c"
        .PARAMETER Choices
        Auswahlmöglichkeiten als Komma-getrennte Sammlung von Chars, z.B. "a,b,c"
        #>
        [CmdletBinding()]
        param
        (
    ...
    #region Function Select True/False
	    function Select-TF
	    {
            <#
            .SYNOPSIS
            Stellt wie die Function "Use-Choice" eine Abfrage von Optionen bereit, hier vordefiniert mit "t,f", stellvertretend für TRUE/FALSE, was dann auch als Resultat wiedergegeben wird.
            .DESCRIPTION
            Stellt wie die Function "Use-Choice" eine Abfrage von Optionen bereit, hier vordefiniert mit "t,f", stellvertretend für TRUE/FALSE, was dann auch als Resultat wiedergegeben wird.
            .EXAMPLE
            $choice = Select-TF
    ...
    #region Function Select Ja/Nein
	function Select-JN
	{
        <#
        .SYNOPSIS
        Stellt wie die Function "Use-Choice" eine Abfrage von Optionen bereit, hier vordefiniert mit "j,n", stellvertretend für JA/NEIN. Als Resultat wird TRUE oder FALSE wiedergegeben.
        .DESCRIPTION
        Stellt wie die Function "Use-Choice" eine Abfrage von Optionen bereit, hier vordefiniert mit "j,n", stellvertretend für JA/NEIN. Als Resultat wird TRUE oder FALSE wiedergegeben.
        .EXAMPLE
        $choice = Select-JN
    ...
    #region Function Select Yes/No
    function Select-YN
	{
        <#
        .SYNOPSIS
        Stellt wie die Function "Use-Choice" eine Abfrage von Optionen bereit, hier vordefiniert mit "y,n", stellvertretend für YES/NO. Als Resultat wird TRUE oder FALSE wiedergegeben.
        .DESCRIPTION
        Stellt wie die Function "Use-Choice" eine Abfrage von Optionen bereit, hier vordefiniert mit "y,n", stellvertretend für YES/NO. Als Resultat wird TRUE oder FALSE wiedergegeben.
        .EXAMPLE
        $choice = Select-YN

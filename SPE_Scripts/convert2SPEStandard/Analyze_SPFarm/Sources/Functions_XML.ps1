...
# ################################################################### #
# 0.1  | S.Josupeit | Erst-Erstellung                    | 08.01.2015 #
######################################################################>
#endregion
...
#region Functions
    ...
    #region Function Ensure-XMLFile
    function Ensure-XMLFile
    {
        <#
        .SYNOPSIS
            Prüft und erstellt bei Nichtvorhandensein ein XML-File
        ...
        .OUTPUTS
            Gibt das XML-Object der gefundenen oder neu erstellten XML-Datei wieder
        ...
        process 
        {
            ...
            if(Test-Path $FilePath)
            {
                ...
                #rename existing XML-File
                $curTime = (Get-Date).ToString().Replace(" ", "_").Replace(".","_").Replace(":","_").Replace("/","_")
                $newFilePath = $FilePath.Replace(".xml", ("_" + $curTime + ".xml"))
    ...
    #region Function Add-XmlChildNode
    Function Add-XmlChildNode
    {
        <#
        .SYNOPSIS
            Erstellt eine ChildNode
        ...
        .OUTPUTS
            Gibt das XML-Object der neu erstellten XML-Node wieder
    ...
    #region Function Get-XMLChildNode
    Function Get-XMLNode
    {
        <#
        .SYNOPSIS
            Erfasst eine XML-Node unterhalb einer anderen.

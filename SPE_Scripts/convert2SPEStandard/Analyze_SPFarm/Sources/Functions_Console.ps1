...
# Powershell-Script                                                   #
# #####################################################################
# Name:     Functions_Console.ps1                                     #
# Funktion: Dieses Script dient der globalen Bereitstellung von       #
#           Functions zur Console-Manipulation                        #
# ################################################################### #
# # Versionsverlauf:                                                # #
# ################################################################### #
...
#region Functions
	...
	#region Function Resize-ConsoleBuffer
	function Resize-ConsoleBuffer([int]$width,[int]$height)
	{	
	...
	#region Function Resize-ConsoleSize
	function Resize-ConsoleSize([int]$width,[int]$height)
	{
	...
	#region Function Set-ConsoleForeGroundColor
	function Set-ConsoleForeGroundColor([string]$color)
	{
		$host.UI.RawUI.ForegroundColor = $string
	}
	#endregion
	
	#region Function Set-ConsoleBackGroundColor
	function Set-ConsoleBackGroundColor([string]$color)
	{
		$host.UI.RawUI.BackgroundColor = $string
	}
	#endregion

	#region Function Set-ConsoleColors
	function Set-ConsoleColors([string]$fore,[string]$back)
	{
		Set-ConsoleForeGroundColor -color $fore
		Set-ConsoleBackGroundColor -color $back
	}
	#endregion
